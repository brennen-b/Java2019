		...
		if ((highwayNumber > 0) && (highwayNumber <1000)) {
			if (length == 3) {
				if (highwayString.charAt(2) == '0' || highwayString.charAt(2) == '2' || highwayString.charAt(2) == '4' || highwayString.charAt(2) == '6' || highwayString.charAt(2) == '8') {
					if (highwayString.charAt(1) == '0')
					System.out.println("The " + highwayString + " is auxiliary, serving the " + highwayString.charAt(2) + ", going east/west.");
					
				   else
					System.out.println("The " + highwayString + " is auxiliary, serving the " + highwayString.charAt(1) + highwayString.charAt(2) + ", going east/west.");
				}
				else 
				   if (highwayString.charAt(1) == '0')
					System.out.println("The " + highwayString + " is auxiliary, serving the " + highwayString.charAt(2) + ", going north/south.");
					
				   else
					System.out.println("The " + highwayString + " is auxiliary, serving the " + highwayString.charAt(1) + highwayString.charAt(2) + ", going north/south.");   
			}
		else if (length == 2) {
